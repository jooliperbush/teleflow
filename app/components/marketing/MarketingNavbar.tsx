  ...
  return (
    <>
      <motion.nav
        ...
        {/* Phone number */}
        <a href="tel:01274952123" className={`hidden md:flex items-center gap-2 text-sm font-semibold transition-colors ${scrolled ? "text-gray-700 hover:text-gray-900" : "text-white/80 hover:text-white"}`}>
