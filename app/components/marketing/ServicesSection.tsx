...
const services = [
  ...
  { id: "voip", iconSrc: "/icons/icon-voip.svg", label: "VoIP", title: "Modern phone systems that work the way your team does.",
    desc: "Cloud-based calling across desk phones, laptops, and mobiles — with unlimited UK calls and full 2027 PSTN compliance built in from day one.",
    features: ["100% uptime guarantee with call recording and hunt groups", "Desktop and mobile app — office or remote, it just works", "From £12/user/mo, scales from 1 user to hundreds"],
    cta: { label: "Get a VoIP quote", href: "/order" } },
